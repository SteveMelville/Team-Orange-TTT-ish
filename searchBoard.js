...
function leftDiagonal(placedLetterPosition){
    ...
    while(newGame.board.get(`${currentPosition - newGame.board.getWidth() - 1}`) != null && !(document.getElementById(`${currentPosition - newGame.board.getWidth() - 1}`).firstChild.src.includes("blank"))){
